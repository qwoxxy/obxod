...
--filter-tcp=443 --hostlist="list-general.txt" --dpi-desync=disorder ) --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls="%BIN%tls_clienthello_www_google_com.bin"
